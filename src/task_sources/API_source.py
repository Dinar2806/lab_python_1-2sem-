    ...
    def __init__(
        ...
        self._mock_database = {
            ...
            "todo": [
                ...
                {"id": 202, "payload": {"title": "Сходить в спортзал", "priority": "medium"}},
                {"id": 203, "payload": {"title": "Почитать книгу", "priority": "low"}}
            ],
            "weather": [
                {"id": 301, "payload": {"city": "Moscow", "temp": -5, "condition": "snow"}},
                {"id": 302, "payload": {"city": "London", "temp": 8, "condition": "rain"}},
                {"id": 303, "payload": {"city": "New York", "temp": 12, "condition": "cloudy"}}
            ],
